...
// SetBitmapBatchPredicate sets a standard bitmap predicate for multiple row IDs.
func (f *QueryFragment) SetBitmapBatchPredicate(index, field string, values []*big.Int) {
	f.Index = index
	f.Field = field
	f.Values = values
}
