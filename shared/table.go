...
func ValueTypeFromString(vt string) qsbridge.ValueKind {
	switch vt {
	case "NotExist":
		return qsbridge.ValueNull
	case "String":
...
func (a *BasicAttribute) IsBSI() bool {
	...
	case "IntBSI", "FloatScaleBSI", "TimestampBSI", "TimeStampBSI", "SysMillisBSI", "SysMicroBSI", "SysSecBSI", "StringHashBSI", "StringLexBSI", "UUIDBSI", "CustomBSI", "ParentRelation":
		return true
	default:
		return false
	}
