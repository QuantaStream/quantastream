...
var (
	// OpDeadline - Table operation gRPC calls should complete within 60 seconds.
	OpDeadline time.Duration = 60 * time.Second
	// CommitDeadline - Explicit durability commits can persist large fact-table shard sets.
	CommitDeadline time.Duration = 5 * time.Minute
