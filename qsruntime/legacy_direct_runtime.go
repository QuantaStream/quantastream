...
func schemaMutationNeedsSyntheticHandle(kind qsbridge.MutationKind) bool {
	switch kind {
	case qsbridge.MutationCreateTable, qsbridge.MutationDropTable, qsbridge.MutationAlterTableAddColumn, qsbridge.MutationAlterTableAddPrimaryKey, qsbridge.MutationAlterTableAddForeignKey, qsbridge.MutationCreateView, qsbridge.MutationDropView:
		return true
	default:
		return false
	}
...
func (p LegacyQuantaSourceSessionProvider) ReadRelationshipVectorReverseArtifactCandidates(ctx context.Context, read LegacyDirectRelationshipVectorReadRequest, sourceValues []int64) (LegacyDirectRelationshipVectorReverseArtifactCandidateResult, qsbridge.DiagnosticSet, bool, error) {
	...
	rownums, rawParentValues, parentValueByChild, stats, sourceValueCount, lookupElapsed, ok, err := legacyDirectRelationshipReverseArtifactCandidateValues(
		...
		read.PreserveArtifactOrder,
		read.DeriveArtifactRows,
		read.OmitArtifactParentValues,
	)
...
func (p LegacyQuantaSourceSessionProvider) ReadRelationshipVectorAggregate(ctx context.Context, read LegacyDirectRelationshipVectorAggregateRequest) (LegacyDirectRelationshipVectorAggregateResult, qsbridge.DiagnosticSet, bool, error) {
	...
	if sourceValueMode {
		...
		result := LegacyDirectRelationshipVectorAggregateResult{
			...
			LookupValueElapsed:         stats.LookupValueElapsed,
			LookupBitmapElapsed:        stats.LookupBitmapElapsed,
			LookupToArrayElapsed:       stats.LookupToArrayElapsed,
			LookupRowSliceElapsed:      stats.LookupRowSliceElapsed,
			LookupRowSliceGroups:       stats.LookupRowSliceGroups,
			LookupMode:                 stats.LookupMode,
			LookupGroups:               stats.LookupGroups,
...
func (h LegacyQuantaSessionHandle) ExecuteMutation(ctx context.Context, request ExecutionRequest) (qsbridge.StatementResult, qsbridge.DiagnosticSet, error) {
	...
	case qsbridge.MutationAlterTableAddColumn:
		return h.AlterTableAddColumn(ctx, request)
