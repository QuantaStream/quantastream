...
func (d correlatedAverageQuantityDescriptor) subqueryPlanIntent() qsbridge.SubqueryPlanIntent {
	...
	return qsbridge.SubqueryPlanIntent{
		...
		CorrelatedAggregate: &qsbridge.CorrelatedAggregateSubqueryIntent{
			...
			Factor:               d.Factor,
			OuterValue:           d.OuterQuantity.fieldRef(),
			InnerValue:           d.InnerQuantity.fieldRef(),
			InnerKey:             d.InnerKey.fieldRef(),
			OuterKey:             d.OuterKey.fieldRef(),
			RequiredFilterFields: correlatedFieldRefs(d.RequiredFilters),
