...
qs_load_env() {
  ...
  QS_REVERSE_ARTIFACT_WARM_MEMBERSHIP_TIMEOUT="${QS_REVERSE_ARTIFACT_WARM_MEMBERSHIP_TIMEOUT:-3m}"
  QS_CONSUL_HEALTH_CHECK_PROFILE="${QS_CONSUL_HEALTH_CHECK_PROFILE:-}"
  QS_CONSUL_HEALTH_CHECK_INTERVAL="${QS_CONSUL_HEALTH_CHECK_INTERVAL:-}"
  QS_CONSUL_HEALTH_CHECK_TIMEOUT="${QS_CONSUL_HEALTH_CHECK_TIMEOUT:-}"
  QS_CONSUL_HEALTH_CHECK_FAILURES_BEFORE_CRITICAL="${QS_CONSUL_HEALTH_CHECK_FAILURES_BEFORE_CRITICAL:-}"
  QS_CONSUL_HEALTH_CHECK_DEREGISTER_AFTER="${QS_CONSUL_HEALTH_CHECK_DEREGISTER_AFTER:-}"
  QS_CLUSTER_WAIT_SECONDS="${QS_CLUSTER_WAIT_SECONDS:-600}"
