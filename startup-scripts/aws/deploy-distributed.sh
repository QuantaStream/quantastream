...
deploy_node() {
  ...
  qs_remote_bash "$host" "cd '$QS_REPO_DIR' && ${update_cmd}QUANTASTREAM_NODE_HASH_KEY='$node_key' QUANTASTREAM_DATA_DIR='$QS_NODE_DATA_DIR' QUANTASTREAM_NODE_PORT='$QS_NODE_PORT' QUANTASTREAM_CONSUL_ENDPOINT='$QS_NODE_CONSUL_ENDPOINT' QUANTASTREAM_REQUIRE_LOCAL_CONSUL='$QS_NODE_REQUIRE_LOCAL_CONSUL' QUANTASTREAM_SKIP_NODE_SYNC='$QS_SKIP_NODE_SYNC' QUANTASTREAM_REVERSE_ARTIFACT_WARM_MEMBERSHIP_TIMEOUT='$QS_REVERSE_ARTIFACT_WARM_MEMBERSHIP_TIMEOUT' QUANTASTREAM_CONSUL_HEALTH_CHECK_PROFILE='$QS_CONSUL_HEALTH_CHECK_PROFILE' QUANTASTREAM_CONSUL_HEALTH_CHECK_INTERVAL='$QS_CONSUL_HEALTH_CHECK_INTERVAL' QUANTASTREAM_CONSUL_HEALTH_CHECK_TIMEOUT='$QS_CONSUL_HEALTH_CHECK_TIMEOUT' QUANTASTREAM_CONSUL_HEALTH_CHECK_FAILURES_BEFORE_CRITICAL='$QS_CONSUL_HEALTH_CHECK_FAILURES_BEFORE_CRITICAL' QUANTASTREAM_CONSUL_HEALTH_CHECK_DEREGISTER_AFTER='$QS_CONSUL_HEALTH_CHECK_DEREGISTER_AFTER' ENABLE_NOW='$enable_now' sudo -E ./startup-scripts/install-distributed-node-service.sh"
}
