...
var builtinFunctionDefinitions = []FunctionDefinition{
	...
	builtinScalarFunction("concat_ws", DataTypeString, sqlExpressionFunctionContexts),
	...
	builtinScalarFunction("repeat", DataTypeString, sqlExpressionFunctionContexts),
	builtinScalarFunction("reverse", DataTypeString, sqlExpressionFunctionContexts),
	builtinScalarFunction("lpad", DataTypeString, sqlExpressionFunctionContexts),
	builtinScalarFunction("rpad", DataTypeString, sqlExpressionFunctionContexts),
	builtinScalarFunction("ascii", DataTypeInt, sqlExpressionFunctionContexts),
	builtinScalarFunction("locate", DataTypeInt, sqlExpressionFunctionContexts),
	builtinScalarFunction("instr", DataTypeInt, sqlExpressionFunctionContexts),
	...
	builtinScalarFunction("floor", DataTypeFloat, sqlExpressionFunctionContexts),
	builtinScalarFunction("ceil", DataTypeFloat, sqlExpressionFunctionContexts, "ceiling"),
	builtinScalarFunction("truncate", DataTypeFloat, sqlExpressionFunctionContexts),
	builtinScalarFunction("mod", DataTypeFloat, sqlExpressionFunctionContexts),
	builtinScalarFunction("pow", DataTypeFloat, sqlExpressionFunctionContexts, "power"),
	builtinScalarFunction("sign", DataTypeInt, sqlExpressionFunctionContexts),
	...
	builtinScalarFunction("date", DataTypeString, sqlExpressionFunctionContexts),
	...
	builtinScalarFunction("dayname", DataTypeString, sqlExpressionFunctionContexts),
	builtinScalarFunction("monthname", DataTypeString, sqlExpressionFunctionContexts),
