...
func PhysicalIntentForQueryKind(kind QueryKind) PhysicalAccessIntent {
	switch kind {
	case QueryKindInsert, QueryKindUpdate, QueryKindDelete, QueryKindTruncate, QueryKindCreateTable, QueryKindDropTable, QueryKindCreateView, QueryKindDropView, QueryKindDDL:
